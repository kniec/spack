...
class Clingo(CMakePackage):
    ...
    # Newer versions of cmake fail to build against older gcc versions without setting CXX in
    # the environment. This avoids that.
    depends_on('cmake@3.6.0', when="+cxx11")
